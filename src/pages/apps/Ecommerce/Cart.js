...
const Cart = (): React$Element<React$FragmentType> => {
    ...
    const _adjustCart = (localItems) => {
        ...
        setItems(localItems);
        setSummary({ ...summary, gross_total: newGrossTotal, net_total: newNetTotel });
    };
        ...
        <>
            <PageTitle
                breadCrumbItems={[
                    ...
                    { label: 'Shopping Cart', path: '/apps/ecommerce/shopping-cart', active: true },
                ]}
                title={'Shopping Cart'}
            />
                                    ...
                                    <Row className="mt-4">
                                        ...
                                        <Col sm={6}>
                                            <div className="text-sm-end">
                                                <a href="/apps/ecommerce/checkout" className="btn btn-danger">
